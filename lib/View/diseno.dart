...
class Diseno extends StatelessWidget {
  const Diseno({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Test(title: 'Diseño con IA'),
    );
  }
}
...
class _TestState extends State<Test> {
  ...
  final String apiKey = 'sk-XrNIAGKOTGein55kdMlliDizbadmnMnNsNdZUIjOOgWLWOJ3';
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Escribe para generar una imagen',
